...
class BYSubmit(BaseSubmit):
    ...
    def disclosure_info(self):
        disclosure_req = {
            ...
            "br_stock_disclosure": fake.random_int(1, 99),
    ...
    def cert_info(self):
        cert_req = {
            "cert_type": fake.random_int(1, 99),
            "cert_number": fake.random_int(100000000, 999999999),
            "cert_country": fake.country(),
            "cert_state": fake.state(),
            "cert_city": fake.city(),
            "validate": fake.date()
        }
